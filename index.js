...
window.addEventListener("load", function () {
    setTimeout(function() {
    document.getElementById("navbar-skeleton").style.display = "none";
  ...
  document.addEventListener("DOMContentLoaded", function() {
    ...
    setTimeout(function() {
        ...
        document.getElementById("skeleton-banner-loader").style.display = "none";
        // Show the actual content
        document.getElementById("actual-banner-content").style.display = "block";
